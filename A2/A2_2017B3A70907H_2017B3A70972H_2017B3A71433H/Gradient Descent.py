...
if __name__ == '__main__':
    ...
    print("Variance of accuracy prediction of training data: ",var_train_error)
    #print("Minimum error of training data: ",min_train_error)
    
    print("\nMean accuracy prediction of testing data: ",test_mean_err)
    print("Variance of accuracy prediction of testing data: ",var_test_error)
